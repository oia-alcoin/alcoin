#############################################################################
# Makefile for building: Alcoin-Qt.app/Contents/MacOS/Alcoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Tue Oct 23 06:22:05 2018
# Project:  Alcoin-qt.pro
# Template: app
# Command: /usr/local/Cellar/qt@4/4.8.7_5/bin/qmake RELEASE=1 USE_UPNP=- USE_QRCODE=1 -o Makefile Alcoin-qt.pro
#############################################################################
...
DIST          = /usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/unix.conf \
		...
		Alcoin-qt.pro
QMAKE_TARGET  = Alcoin-Qt
DESTDIR       = 
TARGET        = Alcoin-Qt.app/Contents/MacOS/Alcoin-Qt
...
all: Makefile Alcoin-Qt.app/Contents/PkgInfo Alcoin-Qt.app/Contents/Resources/empty.lproj Alcoin-Qt.app/Contents/Info.plist Alcoin-Qt.app/Contents/Resources/alcoin.icns $(TARGET)

$(TARGET): /Users/omisaal/alcoin/src/leveldb/libleveldb.a /Users/omisaal/alcoin/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_qrcodedialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) Alcoin-Qt.app/Contents/MacOS/ || $(MKDIR) Alcoin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Alcoin-qt.pro  /usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/unsupported/macx-clang/qmake.conf /usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/clang.conf \
	...
	$(QMAKE) RELEASE=1 USE_UPNP=- USE_QRCODE=1 -o Makefile Alcoin-qt.pro
...
Alcoin-Qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) Alcoin-Qt.app/Contents || $(MKDIR) Alcoin-Qt.app/Contents 
	@$(DEL_FILE) Alcoin-Qt.app/Contents/PkgInfo
	@echo "APPL????" >Alcoin-Qt.app/Contents/PkgInfo
Alcoin-Qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) Alcoin-Qt.app/Contents/Resources || $(MKDIR) Alcoin-Qt.app/Contents/Resources 
	@touch Alcoin-Qt.app/Contents/Resources/empty.lproj
	
Alcoin-Qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) Alcoin-Qt.app/Contents || $(MKDIR) Alcoin-Qt.app/Contents 
	@$(DEL_FILE) Alcoin-Qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,0.8,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,alcoin.icns,g" -e "s,@EXECUTABLE@,Alcoin-Qt,g" -e "s,@TYPEINFO@,????,g" share/qt/Info.plist >Alcoin-Qt.app/Contents/Info.plist
Alcoin-Qt.app/Contents/Resources/alcoin.icns: src/qt/res/icons/alcoin.icns
	@$(CHK_DIR_EXISTS) Alcoin-Qt.app/Contents/Resources/ || $(MKDIR) Alcoin-Qt.app/Contents/Resources/ 
	@$(DEL_FILE) Alcoin-Qt.app/Contents/Resources/alcoin.icns
	@$(COPY_FILE) src/qt/res/icons/alcoin.icns Alcoin-Qt.app/Contents/Resources/alcoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/Alcoin-Qt0.8.7.4 || $(MKDIR) build/Alcoin-Qt0.8.7.4 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Alcoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/Alcoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/Alcoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/scrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/qt/qrcodedialog.h src/qt/macdockiconhandler.h src/qt/macnotificationhandler.h build/Alcoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/Alcoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/scrypt.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/qt/qrcodedialog.cpp build/Alcoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/Alcoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui src/qt/forms/qrcodedialog.ui build/Alcoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/Alcoin-Qt0.8.7.4/ && (cd `dirname build/Alcoin-Qt0.8.7.4` && $(TAR) Alcoin-Qt0.8.7.4.tar Alcoin-Qt0.8.7.4 && $(COMPRESS) Alcoin-Qt0.8.7.4.tar) && $(MOVE) `dirname build/Alcoin-Qt0.8.7.4`/Alcoin-Qt0.8.7.4.tar.gz . && $(DEL_FILE) -r build/Alcoin-Qt0.8.7.4


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /Users/omisaal/alcoin/src/leveldb/libleveldb.a; cd /Users/omisaal/alcoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
distclean: clean
	-$(DEL_FILE) -r Alcoin-Qt.app
	-$(DEL_FILE) Makefile


/Users/omisaal/alcoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/omisaal/alcoin/src/leveldb && CC=clang CXX=llvm-g++ $(MAKE) OPT="-pipe -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -arch x86_64 -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX10.7.sdk -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/Users/omisaal/alcoin/build/build.h: FORCE
	cd /Users/omisaal/alcoin; /bin/sh share/genbuild.sh /Users/omisaal/alcoin/build/build.h
