...
uint256 hashGenesisBlock("0xcf11c0af5feea1745864eae07e82d65cad3377d686bb50356ca8901f7a9c8e00");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 210240); // Alcoin: 840k blocks in ~2 year
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcf11c0af5feea1745864eae07e82d65cad3377d686bb50356ca8901f7a9c8e00");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Birth of Alcoin on 6th of Jan 2018";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x201517c5966d1929836b1fc6c18ba08d8dd77725374fdac99fa99e36ef29c758"));
...
unsigned char pchMessageStart[4] = { 0xf3, 0xc5, 0xb4, 0xd1 }; // Alcoin: increase each by adding 2 to bitcoin's value.
